  ...
  return (
    <nav style={{
      ...
      <div style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
        <Link to="/dashboard" style={{ fontWeight: 'bold', textDecoration: 'none', color: '#000' }}>
          AzulTracker
        </Link>
        ...
        {isAdmin() && (
          <>
            ...
            <Link to="/admin/stats" style={linkStyle}>Stats</Link>
            <Link to="/admin/exercises" style={linkStyle}>Exercises</Link>
            <Link to="/admin/videos" style={linkStyle}>Videos</Link>
          </>
        )}
      </div>
